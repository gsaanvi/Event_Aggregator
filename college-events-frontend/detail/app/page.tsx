...
import { ArrowLeft, Calendar, Clock, MapPin, Bookmark, ExternalLink, Bell, User } from "lucide-react"
  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-4 py-6 pb-32 sm:px-6 lg:px-8">
        ...
        {/* Category Badge and Organizer Info */}
          ...
          <div className="flex flex-col gap-3">
            <div className="grid grid-cols-3 gap-3">
              ...
              <Button
                ...
                onClick={handleSave}
                className={isSaved ? "bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100" : ""}
              >
              ...
              <Button
                ...
                className={isReminderSet ? "bg-amber-50 text-amber-700 border-amber-200 hover:bg-amber-100" : ""}
              >
