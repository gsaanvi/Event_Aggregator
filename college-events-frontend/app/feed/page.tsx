...
import { SearchFilters } from "../../feed/components/search-filters";
import { EventCard, type Event } from "../../feed/components/event-card";
import { useAuth } from "../../feed/hooks/useAuth";
import { Spinner } from "../../feed/components/ui/spinner";
import {
  fetchEvents,
  getSavedEvents,
  saveEvent,
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {showPageLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h2 className="mb-2 text-lg font-semibold text-foreground">No events found</h2>
